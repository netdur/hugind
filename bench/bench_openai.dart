...
Future<void> main(List<String> args) async {
  final parser = ArgParser()
    ...
    ..addOption('api-key', defaultsTo: 'nopass', help: 'API Key')
    ..addOption('model',
  ...
  stdout.writeln('Benchmarking $baseUrl with model $model');
  ...
  stdout.writeln('Avg TPOT (Time Per Output Token): ${formatFixed(mean(tpots))}s');
