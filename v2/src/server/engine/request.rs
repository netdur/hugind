...
pub struct RequestParams {
    pub id: String, // User provided or auto-generated
    pub prompt: String,
    pub images: Vec<Vec<u8>>, // Placeholders for multimodal
    pub sampling: SamplingConfig,
    /// Max output tokens. Use -1 for no cap.
...
pub struct Request {
    ...
    pub(crate) prompt_tokens: Vec<Token>, // Tokenized prompt
    ...
    pub(crate) _buffer: VecDeque<u8>, // For detokenization streaming
