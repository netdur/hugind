...
class CurrentDirIOOverrides extends IOOverrides {
  ...
  @override
  Future<FileStat> stat(String path, {bool followLinks = true}) async =>
      FileStat.stat(p.normalize(p.join(currentDir, path)),
          followLinks: followLinks);

  @override
  FileStat statSync(String path, {bool followLinks = true}) =>
